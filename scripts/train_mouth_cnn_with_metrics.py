# train_mouth_cnn_with_metrics.py
import torch
...
plt.xlabel('Epoch')
plt.ylabel('Loss')
plt.title('MouthCNN Training and Validation Loss')
plt.legend()
plt.show()
...
plt.title('MouthCNN Confusion Matrix (Validation Set)')
plt.show()
...
torch.save(model.state_dict(), "models/mouth_cnn.pth")
print("MouthCNN model saved.")
